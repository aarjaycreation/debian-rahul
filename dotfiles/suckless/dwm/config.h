...
static const char *const autostart[] = {
    /* Set resolution */
    "xrandr", "--output", "DP-2", "--mode", "2560x1440", "--rate", "170", NULL,
    ...
    /* sxhkd */
    "sh", "-c", "if hash sxhkd >/dev/null 2>&1; then pkill sxhkd; sleep 0.5; sxhkd -c \"$HOME/.config/suckless/sxhkd/sxhkdrc\" & fi", NULL,
    /* Notifications */
    "dunst", NULL,
    /* Start slstatus */
    "slstatus", NULL,
...
static const Rule rules[] = {
    ...
    { "Lutris",             "lutris",           "Lutris",           1 << 5,         0,              0,              0,              0  },
    { "steam",              NULL,               "Steam",            1 << 5,         0,              0,              0,              0  },
    { "pol.exe",            NULL,               NULL,               1 << 5,         1,              0,              0,              0  },
    //   { "Thunar",             "thunar",           NULL,               1 << 2,         0,              0,              0,              0  },
    { "Cursor",             "cursor",           NULL,               1 << 1,         0,              0,              0,              0  },
    { "thorium-browser",    "thorium-browser",  NULL,               1 << 3,         0,              0,              0,              0  },
    { "discord",            "discord",          NULL,               1 << 4,         0,              0,              0,              0  },
...
static Key keys[] = {
    ...
    { MODKEY|ControlMask,           XK_q,                      spawn,          SHCMD("$HOME/.scripts/power")},
